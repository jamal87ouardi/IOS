...
var P1 = Produit(id: 3, model: "Mx", prix: 350.0, discount: 10)

print(P1.calculerPrix())

var P2 = Produit(id: 6, model: "Wm", prix: 560.0)

P2.afficher()

print(P2.calculerPrix())
 
 */

var ListApparts = [Appartement]()


ListApparts.append(Appartement(numero: 25, surface: 140.0, type: "A1"))
ListApparts.append(Appartement(numero: 3, surface: 120.0, type: "A2", reduction: 10))
ListApparts.append(Appartement(numero: 20, surface: 100.0, type: "A2", reduction: 7))
ListApparts.append(Appartement(numero: 16, surface: 110.0, type: "B1"))

ListApparts[2].afficher()

print(ListApparts[0].calculerPrix())
